...
Referenced by cma::CMA\_\-WType::getWordType().\index{cma::CTypeTokenizer@{cma::CTypeTokenizer}!getCType@{getCType}}
...
Referenced by cma::CMA\_\-WType::getWordType(), and cma::CateStrTokenizer::next().
