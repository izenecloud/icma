...
\subsubsection[{CTypeTokenizer}]{\setlength{\rightskip}{0pt plus 5cm}cma::CTypeTokenizer::CTypeTokenizer (const {\bf CMA\_\-CType} $\ast$ {\em ctype})}\label{classcma_1_1CTypeTokenizer_635764b2db741e1a0b936e2abc206335}
...
\subsubsection[{assign}]{\setlength{\rightskip}{0pt plus 5cm}void cma::CTypeTokenizer::assign (const char $\ast$ {\em str})}\label{classcma_1_1CTypeTokenizer_4004cc1f54cd714e57bb0534496239c5}
...
\subsubsection[{getCType}]{\setlength{\rightskip}{0pt plus 5cm}const {\bf CMA\_\-CType}$\ast$ cma::CTypeTokenizer::getCType () const\hspace{0.3cm}{\tt  [inline]}}\label{classcma_1_1CTypeTokenizer_fb77db9f2b7ca866104e986e1e6f8249}
...
\subsubsection[{next}]{\setlength{\rightskip}{0pt plus 5cm}const char $\ast$ cma::CTypeTokenizer::next ()}\label{classcma_1_1CTypeTokenizer_df2de991ea5258b7237c7b2dca78efea}
...
/home/vernkin/projects/chinese-ma-chen/source/src/{\bf tokenizer.cpp}\end{CompactItemize}
