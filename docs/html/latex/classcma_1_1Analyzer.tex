...
\subsubsection[{getSentenceDelimiter}]{\setlength{\rightskip}{0pt plus 5cm}const char $\ast$ cma::Analyzer::getSentenceDelimiter () const}\label{classcma_1_1Analyzer_eee55c792c0397bc4a58fa162d4fbe01}


Get the delimiter between sentences. \begin{Desc}
...
\subsubsection[{setSentenceDelimiter}]{\setlength{\rightskip}{0pt plus 5cm}void cma::Analyzer::setSentenceDelimiter (const char $\ast$ {\em delimiter})}\label{classcma_1_1Analyzer_2d609843fe10cb82795e06c91d85cc06}


Set the delimiter between sentences, default is empty. \begin{Desc}
\item[Parameters:]
\begin{description}
...
\subsubsection[{sentenceDelimiter\_\-}]{\setlength{\rightskip}{0pt plus 5cm}const char$\ast$ {\bf cma::Analyzer::sentenceDelimiter\_\-}\hspace{0.3cm}{\tt  [protected]}}\label{classcma_1_1Analyzer_27a50ef21d77fa99011cd20bba13768e}
...
/home/vernkin/projects/chinese-ma-chen/source/src/{\bf analyzer.cpp}\end{CompactItemize}
